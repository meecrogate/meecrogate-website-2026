...
const sovereigntyRows = [
  ...
  { feature: "Auditabilité Code", gravitee: { text: "Partielle (Java/Obscur)", status: "warning" as const }, kong: { text: "Complexe (Lua/C++)", status: "warning" as const }, cloud: { text: "Boîte noire (SaaS)", status: "bad" as const }, meecrogate: { text: "Haute (Lean & Lisible)", status: "good" as const } },
